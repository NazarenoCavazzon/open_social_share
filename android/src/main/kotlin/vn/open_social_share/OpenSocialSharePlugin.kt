...
import vn.open_social_share.platforms.*

/** OpenSocialSharePlugin */
class OpenSocialSharePlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "open_social_share")
